...
class TestUpdate(unittest.TestCase):
	def setUp(self):
		...
		record11 = Record(11,"11","","",defaultUID,0)
		self.expected = [record9, record10]
		self.updateIDList = ["1", "2", "3", "5", "7"]
		self.testcase = [record1, record2, record3, record4, record5, record6, record7, record8, record9, record10]
	...
	def record_comparison(self, testList, expectedList):
